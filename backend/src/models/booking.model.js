...
const bookingSchema = new mongoose.Schema(
  {
    ...
    refundStatus:{type:String,enum:['none','processing','partially_refunded','refunded','failed'],default:'none',index:true},
    refundedAmount:{type:Number,min:0,default:0},
    refundRequestedAmount:{type:Number,min:0,default:0},
    ...
    refundProviderReference:{type:String,trim:true,default:'',index:true},
    refundFailureReason:{type:String,trim:true,maxlength:500,default:''},
    refundOriginalGuideEarnings:{type:Number,min:0,default:null},
    refundOriginalPlatformFee:{type:Number,min:0,default:null},
