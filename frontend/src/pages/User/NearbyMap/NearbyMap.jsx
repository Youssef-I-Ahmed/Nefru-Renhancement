...
export default function NearbyMap() {
  ...
  const [isLocating, setIsLocating] = useState(() => Boolean(navigator.geolocation));
  ...
  const [maxPriceFilter, setMaxPriceFilter] = useState(MAX_PRICE_FILTER);
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-full border text-xs font-bold transition-all shadow-xs ${
                showFiltersModal || categoryFilter !== "all" || maxPriceFilter < MAX_PRICE_FILTER
                ...
                <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                  ...
                  <button
                    onClick={() => {
                      ...
                      setMaxPriceFilter(MAX_PRICE_FILTER);
                    }}
                ...
                <div className="py-3 space-y-3">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-xs font-bold text-[#003D5B]">EGP {maxPriceFilter.toLocaleString()}</span>
                    </div>
                    <input
                      type="range"
                      min="500"
                    ...
                    <div className="p-1 max-w-[210px]">
                      ...
                      <div className="flex items-center justify-between mt-2 pt-1.5 border-t border-slate-100">
                        <PriceDisplay
                          ...
                          primaryClassName="font-extrabold text-sm text-[#003D5B]"
                          approxClassName="text-[9px] text-slate-500"
                        />
                        <button
                      ...
                      <div className="flex-1 flex flex-col justify-between min-w-0">
                        ...
                        <div className="flex items-center justify-between mt-2 pt-1.5 border-t border-slate-100">
                          <PriceDisplay
                            ...
                            currency={tour.currency || "EGP"}
                            suffix="/person"
                            primaryClassName="font-black text-sm text-[#003D5B]"
                            approxClassName="text-[9px] text-slate-500"
                          />
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="text-right shrink-0">
                          <PriceDisplay
                            ...
                            currency={tour.currency || "EGP"}
                            suffix="per person"
                            primaryClassName="text-sm sm:text-base font-black text-slate-900"
                            approxClassName="text-[9px] text-slate-500"
                          />
                        </div>
                      </div>
